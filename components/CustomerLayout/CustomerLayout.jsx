            ...
            <div className="p-6 border-b border-green-100">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">{user?.email || "alex@example.com"}</p>
                </div>
              </div>
            </div>
      ...
      <div className={cn("flex flex-col min-h-screen", !isMobile && "ml-72")}>
        ...
        {isMobile && (
          <motion.div
            initial={{ y: 100 }}
            animate={{ y: 0 }}
            className="fixed bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-xl border-t border-green-100 shadow-lg"
          >
